...
function Machines(props) {
    ...
    const LINK = `http://127.0.0.1:8000/api/machines/?machine_factory_number=${MFN}`;
    ...
    return (
        <>
            ...
            <div className="machineForm">
                <input className="inputSearch" type="text" name="machine_factory_number" value={MFN} onChange={handleSubmitChange} placeholder="Заводской номер машины"/>
