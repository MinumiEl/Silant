    ...
    return (
        <>
            ...
            <div className='guides'>
                <BridgeModel
                    label="Вид ТО"
                    machineBridgeModel={maintenance?.type_of_maintenance}
                    bridgeModelLink="types_of_maintenance"
                    nameTitle="Название"
                />
                <BridgeModel
                    label="Организация, проводившая ТО"
                    machineBridgeModel={maintenance?.organization}
                    bridgeModelLink="organizations"
                    nameTitle="Название"
                />
                <BridgeModel
